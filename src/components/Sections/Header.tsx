...
const DesktopNav = ({ navSections, currentSection }: { navSections: SectionId[]; currentSection: SectionId | null }) => {
    const baseClass =
...
const MobileNav = ({ navSections, currentSection } : { navSections: SectionId[]; currentSection: SectionId | null }) => {
